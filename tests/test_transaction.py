...
class TestTransaction(unittest.TestCase):
    ...
    def test_shouldCreatePurchaseTransaction(self):
        ...
        for value, expected_value in values:
            transaction = Transaction(date=TEST_DATE,
            ...
            expected = (
                ...
                f"    Expenses:Don't know                            ${expected_value}\n"
                f"    Bank:Checking\n\n"
            )
            
            self.assertEqual(transaction.exportString(), expected, f"Value={value}")
    ...
    def test_shouldCreatePaymentAccountTransaction(self):
        ...
        for value, expected_value in values:
            ...
            expected = (
                f"2025-02-21       TEST DESCRIPTION\n"
                f"    Bank:Checking                            ${expected_value}\n"
